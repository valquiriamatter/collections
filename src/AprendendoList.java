...
public class AprendendoList {
    ...
    public static void main(String[] args) {
        ...
        //Declarando um Map com a implementação de ArrayList
        List<String> listaAlunos = new ArrayList<>();

        //Declarando um Map com a implementação de LinkedList
        List<String> listaAlunosLinked = new LinkedList<>();
        ...
        //Limpando a lista, tornando-a vazia, é útil quando precisamos reusar uma lista existente
        listaAlunos.clear();

        //O método shuffle() serve para embaralhar a ordem de uma lista.
        // Por exemplo em um caso de um sistema de sorteio, em que precisamos de uma ordem aleatória
        // na nossa lista, utilizamos o método shuffle para embaralhá-la.
        ...
        Collections.singletonList(listaAlunos);
        ...
        // de um destes objetos, utilizamos o método nCopies().
        // O bom deste método é que mesmo que nós solicitemos uma lista com um
        // número grande, como 10000 objetos, ele na verdade se referencia a apenas um,
        // ocupando assim um pequeno espaço.
        //Collections.nCopies(listaAlunos);
